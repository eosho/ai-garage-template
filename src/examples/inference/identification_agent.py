...
from factory.llm.providers.azure_inference_provider import AzureInferenceProvider
from hazard_agent.schemas import HazardIdentificationOutput
from factory.llm.factory import LLMFactory
from hazard_agent.prompts.prompts import HAZARD_IDENTIFICATION_PROMPT
from factory.logger.telemetry import LoggingFactory
from factory.tools.generic_tools import get_current_datetime
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image",
        type=str,
        default="src/examples/inference/images/hazard.jpg",
        help="Path to the hazard image to analyze."
    )
    parser.add_argument(
        "--query",
        type=str,
        default="What hazards can you find in this image? Also call the get_current_datetime tool to tell me the date",
